...
ax.plot_surface(x_true, y_true, z_true, color="b", alpha=0.1, edgecolor='k', label="True Sphere")
ax.set_title("Random Sphere Points vs True Sphere")
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_zlabel("Z")
ax.legend(["Random Points", "True Sphere"], loc="upper left")
plt.show()
...
# Cálculo del producto de inercia en el plano dado
...
# Cálculos del momento de inercia y producto de inercia
