...
Sistema = (
    ...
    lambda w0, w1, w2, w3, x0, x1, x2, x3: w0*x0**5 + w1*x1**5 + w2*x2**5 + w3*x3**5 - 2/5,  # k = 4
    lambda w0, w1, w2, w3, x0, x1, x2, x3: w0*x0**6 + w1*x1**6 + w2*x2**6 + w3*x3**6,  # k = 5
    lambda w0, w1, w2, w3, x0, x1, x2, x3: w0*x0**7 + w1*x1**7 + w2*x2**7 + w3*x3**7 - 2/7,  # k = 6
    lambda w0, w1, w2, w3, x0, x1, x2, x3: w0*x0**8 + w1*x1**8 + w2*x2**8 + w3*x3**8  # k = 7
)
